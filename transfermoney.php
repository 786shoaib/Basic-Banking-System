...
<head>
    ...
    <style type="text/css">
      ...
      body{
        background:url('img/trans.jpg')no-repeat;
        background-size:100%;
        height: 140px;
        display:block;
        padding:0 !important;
...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr>
                        <td class="py-2" style="color:black"><?php echo $rows['id'] ?></td>
                        <td class="py-2" style="color:black"><?php echo $rows['name']?></td>
                        <td class="py-2" style="color:black"><?php echo $rows['email']?></td>
                        <td class="py-2" style="color:black"><?php echo $rows['balance']?></td>
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color:green">TRANSFER</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
